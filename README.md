<div align="center">
  ...
  <h3>SIBA '26 • Fresh Computer Science Graduate</h3>
  <p style="color: #FF6B6B; font-weight: 900; font-size: 20px; text-shadow: 1px 1px 2px rgba(0,0,0,0.1);">AI Developer . Full Stack Developer . Problem Solver · Building Intelligent Solutions</p>
